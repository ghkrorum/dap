    ...
    <div id="main_container" class="fluid_container">
      ...
      <section id="latest_module" class="section_template">
        ...
        <div class="wrapper_container">
          ...
          <?php echo do_shortcode('[ajax_load_more container_type="ol" css_classes="latest_list" post_type="post" search="'.$searchTerm.'" post__not_in="' . implode(",", $excludePostIdArray ) . '" posts_per_page="8" button_label = "Ver más" button_loading_label="Cargando más noticias" scroll="true"]'); ?>
        </div>
      </section>
      <!-- /LATEST -->
      <?php endif; ?>
